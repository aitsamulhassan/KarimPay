                          ...
                          Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 10.h,),
                                const Center(child: UserButton(color: primary, text: 'Accept', text_color: secondary, height: 5.5, width: 25)),
                                SizedBox(height: 3.h,),
                                const Center(child: UserButton(color: secondary, text: 'Send Again', text_color: primary, height: 5.5, width: 25)),
                              ],
                            ),
                          ),
                        ],
